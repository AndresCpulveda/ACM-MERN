...
import { addRecord, deleteRecord, getAllRecords, getLastRecords, searchName, searchPlate, searchRepair } from '../controllers/clientsController.js';
...
routerClients.post("/search-repair", checkAuth, searchRepair)
